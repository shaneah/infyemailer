      ...
      <div className="flex justify-center mb-8">
        ...
        >
          ...
          <TabsContent value="campaigns">
            ...
            <p className="mb-6 text-gray-500">This tab will display your campaigns.</p>
          </TabsContent>
          
          <TabsContent value="contacts">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold">Your Contacts</h2>
              <Button variant="default">Add Contacts</Button>
            </div>
            
            <p className="mb-6 text-gray-500">This tab will display your contacts and contact lists.</p>
          </TabsContent>
          ...
          <TabsContent value="templates">
            ...
            <p className="mb-6 text-gray-500">This tab will display your email templates.</p>
          </TabsContent>
          ...
          <TabsContent value="analytics">
            ...
            <p className="mb-6 text-gray-500">This tab will display your campaign analytics and reports.</p>
          </TabsContent>

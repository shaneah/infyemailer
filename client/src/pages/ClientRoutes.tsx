    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {isLoading ? (
          ...
          <div className="col-span-full bg-white shadow-none border border-gray-200 p-8 text-center rounded-none">
            <div className="mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">No Lists Found</h3>
            ...
            <button className="inline-flex items-center px-6 py-2 border-2 border-primary text-sm font-medium text-primary hover:bg-primary hover:text-white transition-colors">

...
export default function TemplateBuilder() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        <div className="flex w-full h-full">
          ...
          <div className="flex h-full">
            <div className="flex flex-col bg-slate-50 border-r border-slate-200 h-full">
              <Tabs value={editorSection} onValueChange={setEditorSection} orientation="vertical" className="w-48">
                <TabsList className="flex flex-col h-auto justify-start bg-transparent px-0 border-b border-slate-200">
                  <TabsTrigger 
                    value="content" 
                    className="justify-start px-6 py-3 font-medium rounded-none border-l-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-white data-[state=active]:text-primary"
                  >
                    Content
                  </TabsTrigger>
                  <TabsTrigger 
            ...
            <TabsContent value="content" className="flex-1 mt-0 p-6 h-full">
              <div className="flex flex-col h-full">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="border rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer hover:shadow-md transition-shadow">
                    <div className="border border-slate-300 rounded w-12 h-12 flex items-center justify-center mb-2">
                      <div className="flex w-8 justify-between">
                        <div className="bg-slate-200 w-2.5 h-6 rounded"></div>
                        <div className="bg-slate-200 w-2.5 h-6 rounded"></div>
                        <div className="bg-slate-200 w-2.5 h-6 rounded"></div>
                      </div>
                    </div>
            ...
            <TabsContent value="design" className="flex-1 mt-0 p-6 h-full">
              <div className="flex flex-col h-full">
                <h2 className="text-xl font-medium mb-6">Design settings</h2>
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      ...
                      <div className="border rounded-md p-3 cursor-pointer hover:border-primary">
                        <div className="h-16 bg-green-50 rounded-sm flex items-center justify-center">
                          <div className="w-3/4 h-4 bg-green-200 rounded"></div>
                        </div>
                        <p className="text-xs mt-2 text-center">Nature</p>
                      </div>
                      <div className="border rounded-md p-3 cursor-pointer hover:border-primary">
                        <div className="h-16 bg-purple-50 rounded-sm flex items-center justify-center">
                          <div className="w-3/4 h-4 bg-purple-200 rounded"></div>
                        </div>
                        <p className="text-xs mt-2 text-center">Creative</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      ...
                      <div className="h-6 w-full bg-violet-500 rounded cursor-pointer"></div>
                      <div className="h-6 w-full bg-gray-700 rounded cursor-pointer"></div>
                    </div>
                  </div>
      ...
      <TabsContent value="send" className="flex-1 p-6 mt-0">
        <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="flex items-center">
                  <input type="radio" name="send-type" className="mr-2" checked />
                  <span>Send now</span>
                </label>
              </div>

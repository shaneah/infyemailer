    ...
    <DndProvider backend={HTML5Backend}>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        {visibleWidgets.length === 0 && (
          <div className="lg:col-span-12 p-8 text-center bg-white rounded-md shadow-sm border border-slate-200">
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <p className="text-lg font-medium text-slate-800 mb-2">No widgets available</p>
              <p className="text-slate-600 mb-6">Add widgets to customize your dashboard experience</p>
              <button 
